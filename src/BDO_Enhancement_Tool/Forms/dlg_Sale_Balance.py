# Form implementation generated from reading ui file 'c:\users\rammc\documents\pycharm3\bdo_enhancement_tool\src\BDO_Enhancement_Tool\Forms\dlg_Sale_Balance.ui'
#
...
class Ui_DlgSaleBalance(object):
    def setupUi(self, DlgSaleBalance):
        ...
        self.txtProfit.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.IBeamCursor))
        ...
        self.buttonBox.accepted.connect(DlgSaleBalance.accept) # type: ignore
        self.buttonBox.rejected.connect(DlgSaleBalance.reject) # type: ignore
