...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -135, 1040, 702))
        ...
        self.gridLayout.addWidget(self.chkMerchantsRingPic, 15, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblQuestFSIncPic, 13, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.chkValuePack, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinQuestFSInc, 13, 2, 1, 1)
        self.lblMarketTax = QtWidgets.QLabel(self.widget_4)
        self.lblMarketTax.setObjectName("lblMarketTax")
        self.gridLayout.addWidget(self.lblMarketTax, 12, 1, 1, 1)
        ...
        self.lblMarketDomainPic = QtWidgets.QLabel(self.widget_4)
        self.lblMarketDomainPic.setMinimumSize(QtCore.QSize(32, 32))
        self.lblMarketDomainPic.setText("")
        self.lblMarketDomainPic.setObjectName("lblMarketDomainPic")
        self.gridLayout.addWidget(self.lblMarketDomainPic, 16, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinValuePack, 14, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblGearCleansePic, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.chkMerchantsRing, 15, 1, 1, 1)
        self.label_4 = QtWidgets.QLabel(self.widget_4)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 16, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblQuestFSInc, 13, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblDragonScalePic, 11, 0, 1, 1)
        ...
        self.lblMOPMCost = QtWidgets.QLabel(self.widget_4)
        self.lblMOPMCost.setObjectName("lblMOPMCost")
        self.gridLayout.addWidget(self.lblMOPMCost, 9, 1, 1, 1)
        self.spinMOPM = NoScrollSpin(self.widget_4)
        self.spinMOPM.setProperty("showGroupSeparator", True)
        self.spinMOPM.setMaximum(999999999)
        self.spinMOPM.setObjectName("spinMOPM")
        self.gridLayout.addWidget(self.spinMOPM, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spin_Cost_Dragon_Scale, 11, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblGearCleanse, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblMarketTaxPic, 12, 0, 1, 1)
        self.lblDragonScale = QtWidgets.QLabel(self.widget_4)
        self.lblDragonScale.setObjectName("lblDragonScale")
        self.gridLayout.addWidget(self.lblDragonScale, 11, 1, 1, 1)
        ...
        self.lblMOPMPic = QtWidgets.QLabel(self.widget_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(32)
        sizePolicy.setVerticalStretch(32)
        sizePolicy.setHeightForWidth(self.lblMOPMPic.sizePolicy().hasHeightForWidth())
        self.lblMOPMPic.setSizePolicy(sizePolicy)
        self.lblMOPMPic.setMinimumSize(QtCore.QSize(32, 32))
        self.lblMOPMPic.setText("")
        self.lblMOPMPic.setObjectName("lblMOPMPic")
        self.gridLayout.addWidget(self.lblMOPMPic, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.spin_Cost_Cleanse, 10, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinMarketTax, 12, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinMerchantsRing, 15, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.chkValuePackPic, 14, 0, 1, 1)
        ...
        self.lblTimePen = QtWidgets.QLabel(self.widget_4)
        self.lblTimePen.setObjectName("lblTimePen")
        self.gridLayout.addWidget(self.lblTimePen, 17, 1, 1, 1)
        self.spinTimePen = NoScrollSpin(self.widget_4)
        self.spinTimePen.setProperty("showGroupSeparator", True)
        self.spinTimePen.setMaximum(999999999)
        self.spinTimePen.setObjectName("spinTimePen")
        self.gridLayout.addWidget(self.spinTimePen, 17, 2, 1, 1)
        self.cmbMarketDomain = QtWidgets.QComboBox(self.widget_4)
        self.cmbMarketDomain.setEditable(True)
        self.cmbMarketDomain.setObjectName("cmbMarketDomain")
        self.cmbMarketDomain.addItem("")
        self.cmbMarketDomain.addItem("")
        self.cmbMarketDomain.addItem("")
        self.cmbMarketDomain.addItem("")
        self.cmbMarketDomain.addItem("")
        ...
        self.cmbMarketDomain.addItem("")
        self.cmbMarketDomain.addItem("")
        self.gridLayout.addWidget(self.cmbMarketDomain, 16, 2, 1, 1)
        ...
        self.table_FS.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.treeFS_Secondary.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.table_FS_Cost.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.table_FS_Cost.setAlternatingRowColors(True)
        self.table_FS_Cost.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ContiguousSelection)
        self.table_FS_Cost.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.table_FS_Cost_Secondary.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.table_FS_Cost_Secondary.setAlternatingRowColors(True)
        self.table_FS_Cost_Secondary.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        self.table_FS_Cost_Secondary.setObjectName("table_FS_Cost_Secondary")
        self.table_FS_Cost_Secondary.setColumnCount(6)
        self.table_FS_Cost_Secondary.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.table_FS_Cost_Secondary.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_FS_Cost_Secondary.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_FS_Cost_Secondary.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_FS_Cost_Secondary.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_FS_Cost_Secondary.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_FS_Cost_Secondary.setHorizontalHeaderItem(5, item)
        self.table_FS_Cost_Secondary.verticalHeader().setVisible(False)
        ...
        self.table_genome.setDragDropMode(QtWidgets.QAbstractItemView.DragDropMode.DragDrop)
        self.table_genome.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.tree_ForProfit = TableForProfit(self.tab_enhanceforprofit)
        self.tree_ForProfit.setEnabled(True)
        self.tree_ForProfit.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.tree_ForProfit.setAlternatingRowColors(True)
        self.tree_ForProfit.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        self.tree_ForProfit.setObjectName("tree_ForProfit")
        self.verticalLayout_11.addWidget(self.tree_ForProfit)
        ...
        self.table_Equip.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.table_Equip.setAlternatingRowColors(True)
        self.table_Equip.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.ExtendedSelection)
        ...
        self.table_Strat.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAlwaysOn)
        self.table_Strat.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.table_Strat.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        self.table_Strat.setSelectionMode(QtWidgets.QAbstractItemView.SelectionMode.SingleSelection)
        self.table_Strat.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectionBehavior.SelectRows)
        ...
        self.table_Strat_FS.setEditTriggers(QtWidgets.QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.chkStratInclSaves = QtWidgets.QCheckBox(self.widget_7)
        self.chkStratInclSaves.setChecked(True)
        self.chkStratInclSaves.setObjectName("chkStratInclSaves")
        self.horizontalLayout_5.addWidget(self.chkStratInclSaves)
        ...
        self.actionGitHub_README = QtGui.QAction(MainWindow)
        self.actionGitHub_README.setObjectName("actionGitHub_README")
        self.actionWindow_Always_on_Top = QtGui.QAction(MainWindow)
        ...
        self.actionGear_Type_Probability_Table = QtGui.QAction(MainWindow)
        self.actionGear_Type_Probability_Table.setObjectName("actionGear_Type_Probability_Table")
        self.actionOpen_Settings_Directory = QtGui.QAction(MainWindow)
        ...
        self.actionOpen_Item_Store = QtGui.QAction(MainWindow)
        self.actionOpen_Item_Store.setObjectName("actionOpen_Item_Store")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "Market Domain: "))
        ...
        self.lblMOPMCost.setText(_translate("MainWindow", "Mass of Pure Magic"))
        ...
        self.lblTimePen.setText(_translate("MainWindow", "Time Penalty (silver/hour)"))
        self.cmbMarketDomain.setItemText(0, _translate("MainWindow", "api.arsha.io/v2/na/"))
        self.cmbMarketDomain.setItemText(1, _translate("MainWindow", "api.arsha.io/v2/eu/"))
        self.cmbMarketDomain.setItemText(2, _translate("MainWindow", "api.arsha.io/v2/sea/"))
        self.cmbMarketDomain.setItemText(3, _translate("MainWindow", "api.arsha.io/v2/mena/"))
        self.cmbMarketDomain.setItemText(4, _translate("MainWindow", "api.arsha.io/v2/kr/"))
        self.cmbMarketDomain.setItemText(5, _translate("MainWindow", "api.arsha.io/v2/ru/"))
        self.cmbMarketDomain.setItemText(6, _translate("MainWindow", "api.arsha.io/v2/jp/"))
        self.cmbMarketDomain.setItemText(7, _translate("MainWindow", "api.arsha.io/v2/th/"))
        self.cmbMarketDomain.setItemText(8, _translate("MainWindow", "api.arsha.io/v2/tw/"))
        self.cmbMarketDomain.setItemText(9, _translate("MainWindow", "api.arsha.io/v2/sa/"))
        self.cmbMarketDomain.setItemText(10, _translate("MainWindow", "api.arsha.io/v2/console_eu/"))
        self.cmbMarketDomain.setItemText(11, _translate("MainWindow", "api.arsha.io/v2/console_na/"))
        self.cmbMarketDomain.setItemText(12, _translate("MainWindow", "api.arsha.io/v2/console_asia/"))
        self.cmbMarketDomain.setItemText(13, _translate("MainWindow", "na-trade.naeu.playblackdesert.com"))
        ...
        self.treeFS_Secondary.headerItem().setText(5, _translate("MainWindow", "Enhance Cost"))
        self.treeFS_Secondary.headerItem().setText(6, _translate("MainWindow", "Cost"))
        self.treeFS_Secondary.headerItem().setText(7, _translate("MainWindow", "Attempts"))
        self.treeFS_Secondary.headerItem().setText(8, _translate("MainWindow", "Attempts b4 Success"))
        ...
        item = self.table_FS_Cost_Secondary.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "FS"))
        item = self.table_FS_Cost_Secondary.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Gear"))
        item = self.table_FS_Cost_Secondary.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Cost"))
        item = self.table_FS_Cost_Secondary.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Cumulitive Cost"))
        item = self.table_FS_Cost_Secondary.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Probability"))
        item = self.table_FS_Cost_Secondary.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Cumulitive Probability"))
        self.table_genome.headerItem().setText(0, _translate("MainWindow", "Name"))
        self.table_genome.headerItem().setText(1, _translate("MainWindow", "Genome"))
        self.table_genome.headerItem().setText(2, _translate("MainWindow", "(un) Fitness"))
        self.table_genome.headerItem().setText(3, _translate("MainWindow", "# FS"))
        ...
        self.tree_ForProfit.headerItem().setText(0, _translate("MainWindow", "Name"))
        self.tree_ForProfit.headerItem().setText(1, _translate("MainWindow", "Gear Type"))
        self.tree_ForProfit.headerItem().setText(2, _translate("MainWindow", "MP: Cost"))
        self.tree_ForProfit.headerItem().setText(3, _translate("MainWindow", "Buy-in Level"))
        self.tree_ForProfit.headerItem().setText(4, _translate("MainWindow", "Sell-out Level"))
        self.tree_ForProfit.headerItem().setText(5, _translate("MainWindow", "FS"))
        self.tree_ForProfit.headerItem().setText(6, _translate("MainWindow", "Margin"))
        self.tree_ForProfit.headerItem().setText(7, _translate("MainWindow", "Cost"))
        self.tree_ForProfit.headerItem().setText(8, _translate("MainWindow", "Cron?"))
        ...
        self.chkStratInclSaves.setText(_translate("MainWindow", "Include Save Stacks"))
        ...
        self.actionOpen_Item_Store.setText(_translate("MainWindow", "Open Item Store"))
from BDO_Enhancement_Tool.Qt_common import NoScrollSpin, NonScrollDoubleSpin
...
from BDO_Enhancement_Tool.Widgets.treeForProfit import TableForProfit
