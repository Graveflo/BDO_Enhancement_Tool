...
class Ui_dlgGearWindow(object):
    def setupUi(self, dlgGearWindow):
        ...
        self.tableEnhanceCosts.setSelectionMode(QtWidgets.QAbstractItemView.NoSelection)
        ...
        self.tableLvlInfo.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tableLvlInfo.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tableLvlInfo.setObjectName("tableLvlInfo")
        self.tableLvlInfo.setColumnCount(5)
    ...
    def retranslateUi(self, dlgGearWindow):
        ...
        item.setText(_translate("dlgGearWindow", "Material Cost"))
