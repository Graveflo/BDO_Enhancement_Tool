...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_Cost_Cleanse = QtWidgets.QSpinBox(self.widget_4)
        self.txt_Cost_Cleanse.setProperty("showGroupSeparator", True)
        self.txt_Cost_Cleanse.setMaximum(999999999)
        self.txt_Cost_Cleanse.setObjectName("txt_Cost_Cleanse")
        self.gridLayout.addWidget(self.txt_Cost_Cleanse, 6, 1, 1, 1)
        ...
        self.txt_Cost_BlackStone_Weapon = QtWidgets.QSpinBox(self.widget_4)
        self.txt_Cost_BlackStone_Weapon.setProperty("showGroupSeparator", True)
        self.txt_Cost_BlackStone_Weapon.setMaximum(999999999)
        self.txt_Cost_BlackStone_Weapon.setObjectName("txt_Cost_BlackStone_Weapon")
        self.gridLayout.addWidget(self.txt_Cost_BlackStone_Weapon, 0, 1, 1, 1)
        self.txt_Cost_BlackStone_Armor = QtWidgets.QSpinBox(self.widget_4)
        self.txt_Cost_BlackStone_Armor.setProperty("showGroupSeparator", True)
        self.txt_Cost_BlackStone_Armor.setMaximum(999999999)
        self.txt_Cost_BlackStone_Armor.setObjectName("txt_Cost_BlackStone_Armor")
        self.gridLayout.addWidget(self.txt_Cost_BlackStone_Armor, 1, 1, 1, 1)
        self.txt_Cost_MemFrag = QtWidgets.QSpinBox(self.widget_4)
        self.txt_Cost_MemFrag.setProperty("showGroupSeparator", True)
        self.txt_Cost_MemFrag.setMaximum(999999999)
        self.txt_Cost_MemFrag.setObjectName("txt_Cost_MemFrag")
        self.gridLayout.addWidget(self.txt_Cost_MemFrag, 4, 1, 1, 1)
        self.txt_Cost_Conc_Weapon = QtWidgets.QSpinBox(self.widget_4)
        self.txt_Cost_Conc_Weapon.setProperty("showGroupSeparator", True)
        self.txt_Cost_Conc_Weapon.setMaximum(999999999)
        self.txt_Cost_Conc_Weapon.setObjectName("txt_Cost_Conc_Weapon")
        self.gridLayout.addWidget(self.txt_Cost_Conc_Weapon, 2, 1, 1, 1)
        self.txt_Cost_Cron = QtWidgets.QSpinBox(self.widget_4)
        self.txt_Cost_Cron.setProperty("showGroupSeparator", True)
        self.txt_Cost_Cron.setMaximum(999999999)
        self.txt_Cost_Cron.setObjectName("txt_Cost_Cron")
        self.gridLayout.addWidget(self.txt_Cost_Cron, 5, 1, 1, 1)
        self.txt_Cost_ConcArmor = QtWidgets.QSpinBox(self.widget_4)
        self.txt_Cost_ConcArmor.setProperty("showGroupSeparator", True)
        self.txt_Cost_ConcArmor.setMaximum(999999999)
        self.txt_Cost_ConcArmor.setObjectName("txt_Cost_ConcArmor")
        self.gridLayout.addWidget(self.txt_Cost_ConcArmor, 3, 1, 1, 1)
