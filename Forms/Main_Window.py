...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table_genome.setColumnCount(3)
        self.table_genome.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.table_genome.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_genome.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_genome.setHorizontalHeaderItem(2, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        item = self.table_genome.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "Name"))
        item = self.table_genome.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Genome"))
        item = self.table_genome.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Fitness"))
