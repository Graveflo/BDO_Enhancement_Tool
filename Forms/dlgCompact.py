...
class Ui_dlgCompact(object):
    def setupUi(self, dlgCompact):
        ...
        self.cmdTray = QtWidgets.QPushButton(dlgCompact)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cmdTray.sizePolicy().hasHeightForWidth())
        self.cmdTray.setSizePolicy(sizePolicy)
        self.cmdTray.setMinimumSize(QtCore.QSize(0, 20))
        self.cmdTray.setObjectName("cmdTray")
        self.gridLayout.addWidget(self.cmdTray, 1, 4, 1, 1)
...
"}")
    ...
    def retranslateUi(self, dlgCompact):
        ...
        self.cmdTray.setToolTip(_translate("dlgCompact", "Information Shelf"))
        self.cmdTray.setText(_translate("dlgCompact", "Choices"))
        self.lblInfo.setText(_translate("dlgCompact", "E: 0% | N: 0 | C: 0%"))
